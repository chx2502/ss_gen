...
def generate(
    ...
    if synonymous:
        replaced_sentences = replace(original_sentence, custom_dict_file, similar_dict_file)
    if trans:
...
def generate_similar_sentences(
    ...
    for txtline in txtlines:
        ...
        similar_sentences = list(set(generate(original_sentence, custom_dict_file, similar_dict_file)))
...
if __name__ == "__main__":
    ...
    output_filename = 'input_wp_trans.txt'
    label = '1'
